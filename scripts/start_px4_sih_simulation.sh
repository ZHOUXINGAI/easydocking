...
MINI_TAKEOFF_ALTITUDE="${MINI_TAKEOFF_ALTITUDE:-40.0}"
...
MINI_ORBIT_SPEED="${MINI_ORBIT_SPEED:-8.8}"
MINI_LOITER_SPEED_COMMAND="${MINI_LOITER_SPEED_COMMAND:-8.8}"
MINI_GLIDE_SPEED_COMMAND="${MINI_GLIDE_SPEED_COMMAND:-8.55}"
MINI_GLIDE_RELEASE_ENABLED="${MINI_GLIDE_RELEASE_ENABLED:-true}"
MINI_TRACKING_SPEED_COMMAND="${MINI_TRACKING_SPEED_COMMAND:-8.55}"
MINI_DOCKING_SPEED_COMMAND="${MINI_DOCKING_SPEED_COMMAND:-8.55}"
MINI_CAPTURE_SPEED_COMMAND="${MINI_CAPTURE_SPEED_COMMAND:-8.55}"
...
MINI_ORBIT_HOLD_READY_ALTITUDE="${MINI_ORBIT_HOLD_READY_ALTITUDE:-24.0}"
MINI_ORBIT_HOLD_ENABLE_DELAY_SEC="${MINI_ORBIT_HOLD_ENABLE_DELAY_SEC:-2.0}"
...
CARRIER_APPROACH_SPEED_LIMIT="${CARRIER_APPROACH_SPEED_LIMIT:-8.0}"
CARRIER_TRACKING_SPEED_LIMIT="${CARRIER_TRACKING_SPEED_LIMIT:-8.85}"
CARRIER_DOCKING_SPEED_LIMIT="${CARRIER_DOCKING_SPEED_LIMIT:-8.4}"
