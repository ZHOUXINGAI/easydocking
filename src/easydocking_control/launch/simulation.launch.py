...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("mini_glide_speed_command", default_value="8.2"),
        ...
        DeclareLaunchArgument("mini_tracking_speed_command", default_value="8.2"),
        DeclareLaunchArgument("mini_docking_speed_command", default_value="8.0"),
        DeclareLaunchArgument("mini_capture_speed_command", default_value="8.0"),
